...
echo "  figures/fig_robustness_stationarity_svar.png — stationarity robustness detail"
echo "  figures/fig_robustness_reduced_form_projection.png — reduced-form detail"
echo "  figures/fig_robustness_ascm.png              — ASCM detail"
